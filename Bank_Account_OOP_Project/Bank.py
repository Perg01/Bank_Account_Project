...
class Bank():
    ...
    def openAccount(self):
        ...
        userAccountPassword = input('What password would you like to use for this account? ')
        userAccountNumber = self.createAccount(userName,userStartingAmount,userAccountPassword)
    ...
    def withdraw(self):
        ...
        print('You withdrew', withdrawAmount)
        print('Your new balance is: ', theBalance)
